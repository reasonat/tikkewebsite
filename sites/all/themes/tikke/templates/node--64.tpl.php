...
<div id="icons">
  <div class="icon-wrapper">
    <div class="icon icon1">
        ...
        <div class="text">
          <div class="title">Large traffic</div>
          <div class="content">The new site faced a big traffic volume along with heavy traffic when posting campaigns.</div>
        </div>
    </div>
    <div class="icon icon2">
        ...
        <div class="text">
          <div class="title">Improve performances</div>
          <div class="content">We have prepared with a good server and performed many proceedings.</div>
        </div>
    </div>
    <div class="icon icon3">
        ...
        <div class="text">
          <div class="title">Maintenance and Monitoring</div>
          <div class="content">Monitor aside to keep the webiste and server in a great condition as a base to success.</div>
        </div>
      </div>
  </div>
</div>

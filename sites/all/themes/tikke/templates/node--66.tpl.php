  ...
  <div class="special-wrapper wrapper">
    <div class="special special1">
        <div class="text">
          ...
          <div class="title">Members club</div>
          <div class="content">Deals and Discounts, points gaining, detail private zone, context marketing and campains.</div>
        </div>
    </div>
    <div class="special special2">
        <div class="text">
          ...
          <div class="content">A complete coupon management tool for creating and editing advance coupons.</div>
        </div>
    </div>
    <div class="special special3">
        <div class="text">
          <div class="number">3</div>
          <div class="title">Deals and Discounts</div>
          <div class="content">Deals & Discount according to different parameters and variables along the website.</div>
        </div>
      </div>
    <div class="special special4">
        <div class="text">
          <div class="number">4</div>
          <div class="title">Bundle products</div>
          <div class="content">Create great product which combine several products into one atractive deal.</div>
        </div>
      </div>
    <div class="special special5">
        <div class="text">
          ...
          <div class="content">Create realtive context marekting through the entire website, dynamic or manual.</div>
        </div>
      </div>
    </div>
</div>
